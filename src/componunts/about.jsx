...
export default function About() {
    ...
    return (
        <div className="">
            ...
            {/* about us */}
            <div className="max-w-7xl mx-auto mt-20 px-4 py-12 grid md:grid-cols-2 gap-16 items-center mb-16 max-width-[1440px]">
                {/* <!-- Left Side --> */}
                <div>
            ...
            {/* Crafting */}
            <section class="text-gray-600 body-font m-auto mb-[150px]">
                <div class="container mx-auto flex px-16 py-24 md:flex-row flex-col max-w-[1440px] items-center">
                    <div class="lg:w-1/2 md:w-1/2 flex flex-col md:items-start md:text-left items-center text-center">
                        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Crafting Quality with Every Stitch
                        </h1>
            ...
            <section class="text-gray-600 body-font bg-[#261606] mt-24 mb-6">
                <div className='max-w-[1440px] py-16 relative m-auto'>
                    <div class="flex flex-wrap  absolute top-[-130px] -m-4 p-4 px-10 w-[100%] left-[0%] m-auto ">
            ...
            <section class="text-gray-600 body-font" style={{
                ...
                <div class="container px-5 py-24 mx-auto">
                    ...
                    <div class="flex flex-wrap gap-5 justify-around -m-4">
                        <div class="p-4 lg:w-1/4 md:w-1/2">
                            <div class="h-full flex flex-col items-center relative text-center">
                                <div className='relative w-full border border-[1px] border-[red] h-[400px] rounded-xl'>
                                ...
                                <div class="w-[80%] left-[10%] py-2 my-2 rounded-xl bottom-[30px] bg-white ">
